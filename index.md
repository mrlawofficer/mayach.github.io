...
<!-- HERO SECTION: Firm Logo + Profile -->
<section class="hero">
  <div class="container">
    <div class="hero-card" style="display:flex;gap:28px;align-items:center;">
      <div style="flex:1;">
        <img src="/assets/images/logo.png" alt="Mayach & Co. Logo" style="width:260px; display:block; margin-bottom:18px;">
        <h1 style="margin:0 0 6px;">Mayach & Co.</h1>
        <p class="lead">A research-led legal practice — litigation, insolvency and advisory.</p>
        <p style="margin-top:14px;">
          <a class="btn" href="/blog/">Read Insights</a>
          <a class="btn ghost" href="/about/cv/">View CV</a>
        </p>
      </div>

      <div style="width:320px;">
        <div class="stack-card" style="padding:18px; text-align:center;">
          <img src="/assets/images/profile.png" alt="Himanshu Soni" style="width:100%; height:auto; border-radius:12px; object-fit:cover;">
          <h3 style="margin:12px 0 4px;">Himanshu Soni</h3>
          <div class="muted">Founder — Mayach & Co. | Law Centre-1, University of Delhi</div>
          <div style="margin-top:10px;font-size:14px;">
            ...
            <div style="margin-top:8px;"><a class="btn ghost" href="/about/cv/">Full CV</a></div>
          </div>
        </div>
      </div>
    </div>
